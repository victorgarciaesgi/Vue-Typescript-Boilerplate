  ...
  <transition name='hide'>
    <ul id="notifications-container" v-show='notificationList.length'>
      <transition-group name='notification'>
        <component :is='isLink(notification)'
          ...
          <div class='notification-icon'>
            ...
            <img src="~@icons/notifications/warning.svg" v-else-if='notification.type == "warning"'>
            <img src="~@icons/notifications/infos.svg" v-else-if='notification.type == "notification"'>
          </div>
